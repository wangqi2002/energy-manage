        ...
        <div class="inner-backstage clearfix">
            <div class="lf left-backstage">
                        ...
                        <div class="clearfix">
                            ...
                            <div class="lf once-tips">
                                ...
                                <div class="h12 shenlan border">
                                    ...
                                    <p class="piaop">车间进出管理系统</p>
                                    <p class="piaop-p">洁净区闸机检票</p>
                                </div>
                                <div class="h157 blue border">
                                    <div class="h157 blue border">
                ...
                <div class="scenicSpots">
                    <h3 class="title-service">工厂大数据</h3>
...
.backstageapplication .inner-backstage {
    width: 72.8%;
    margin: 0 auto;
    padding-top: .7rem;
    height: 7rem
...
.backstageapplication .intelligentService {
    margin-right: .6rem;
}

.backstageapplication .title-service {
    font-size: 18px;
    color: #fff;
    font-weight: normal;
...
.backstageapplication .left-backstage {
    margin-right: .58rem
}

.backstageapplicatioright {
    width: 4.79rem;
}

.backstageapplication .once-tips {
    width: 1.49rem;
    margin-right: .11rem;
}

.backstageapplication .border {
    border-radius: 4px;
    margin-top: .1rem;
    width: 1.49rem;
}

.backstageapplication .h12 {
    height: 1.2rem;
}

.backstageapplication .two-tips {
    width: 1.49rem;
    margin-right: .1rem
}

.backstageapplication .h157 {
    height: 1.57rem;
}
...
.backstageapplication .h165 {
    height: 1.65rem
}

.backstageapplication .callCenter {
    background: #e6ba01;
    height: 1.57rem
}
...
.backstageapplication .scenicSpots {
    margin-top: .55rem;
}

.backstageapplication .scenic-cont {
    height: 1.36rem;
    width: 100%;
...
.backstageapplication .service-right .once-tips {
    margin-right: 0
}
...
.backstageapplication .mr0 {
    margin-right: 0
}

.backstageapplication .w148 {
    width: 1.46rem;
}

.backstageapplication .video-manage {
    width: 3.08rem;
}

.backstageapplication .shenlvs {
    width: 1.48rem;
    margin-left: .1rem
}
...
.backstageapplication p.second-p {
    padding-top: .03rem
}
...
.backstageapplication .zdp {
    padding-top: .45rem
}

.backstageapplication .piaop {
    padding-top: .1rem
}

.backstageapplication .piaop-p {
    padding-top: 0
}
...
.backstageapplication .specil-p {
    margin-left: .5rem;
    padding-top: .42rem
}

.backstageapplication .specil-p1 {
    margin-left: .56rem;
    padding-top: .42rem
}
