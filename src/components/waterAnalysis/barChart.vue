    ...
    <div class="lf screen-wrap ml mt12">
      ...
      <div class="area-wrap">
        <div class="area-inner">
          <div id="myChartunit2Water" style="width:100%;height:100%;"></div>
        </div>
      </div>
...
export default {
  ...
  methods: {
    search_handler() {
      ...
      console.log(_self);
      $.ajax({
        url: this.baseURL.serverSrc + 'unit2_water',  // 后端地址
        type: 'post',
    ...
    drawBar() {
      ...
      let myChart = this.$echarts.init(document.getElementById('myChartunit2Water'));
      // 绘制图表
      let option = {
