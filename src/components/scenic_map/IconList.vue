    ...
    <div class="spot-nav">
        <ul class="Icons" :style="styles">
            <li class="Icon" v-for="item in icons" :key=item.id>
                <div class="Icon-box">
                    <span v-on:click="clickType(item)" class="block Icon-box-icon"
                        :class="[item.order == isActive ? 'active' : '', item.icon]"></span>
                    <span class="block Icon-box-font"
                        :class="[item.order == isActive ? 'font-active' : '']">{{ item.name }}</span>
                </div>
            </li>
        </ul>
    </div>
