    ...
    <div class="lf screen-wrap ml mt12">
      ...
      <div class="area-wrap">
        <div class="area-inner">
          <div id="myChartunit1Steam" style="width:100%;height:100%;"></div>
        </div>
      </div>
...
export default {
  ...
  methods: {
    search_handler() {
      ...
      console.log(_self);
      $.ajax({
        url: this.baseURL.serverSrc + 'unit1_steam',  // 后端地址
        type: 'post',
    ...
    drawBar() {
      ...
      for (let i = 0; i < this.unit1_data.length; i++) {
        ...
        myDataY1.push(this.unit1_data[i]["unit1_steam"]);
      }
      let myChart = this.$echarts.init(document.getElementById('myChartunit1Steam'));
      // 绘制图表
      let option = {
